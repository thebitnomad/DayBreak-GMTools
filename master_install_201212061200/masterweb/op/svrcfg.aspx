...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" Runat="Server">
	<ext:FormPanel ID="FormPanel1" runat="server" PaddingSummary="10px 20px 10px 5px" DefaultAnchor="0" LabelAlign="Right" Border="false" LabelWidth="150" ButtonAlign="Center">
		<Items>
			...
			<ext:FieldSet ID="FieldSet3" runat="server" Title="<%$ Resources:StringDef, SvrCfgDb %>" Collapsible="true" Layout="form">
				<Items>
					...
					<ext:TextField runat="server" ID="TextFieldDbName" FieldLabel="<%$ Resources:StringDef, SvrCfgDbDBName %>" AnchorHorizontal="90%" NoteAlign="Down" Note="<%$ Resources:StringDef, MsgSvrCfgDBNameNote %>" NoteCls="notedbname" />
			...
			<ext:FieldSet ID="FieldSet6" runat="server" Title="<%$ Resources:StringDef, SvrCfgLogDb %>" Collapsible="true" Layout="form">
				<Items>
					...
					<ext:TextField runat="server" ID="TextFieldLogDbName" FieldLabel="<%$ Resources:StringDef, SvrCfgDbDBName %>" AnchorHorizontal="90%" Disabled="true" NoteAlign="Down" Note="<%$ Resources:StringDef, MsgSvrCfgLogDBNameNote %>" NoteCls="notedbname" />
			...
			<ext:FieldSet ID="FieldSet4" runat="server" Title="eRating" Collapsible="true" Layout="form">
				<Items>
					...
					<ext:TextField runat="server" ID="TextFieldGatewayPwd" FieldLabel="<%$ Resources:StringDef, SvrCfgPaymentGatewayPwd %>" AnchorHorizontal="90%" InputType="Password" Note="<%$ Resources:StringDef, MsgEmptyUseOriPwd %>" />
					<ext:TextField runat="server" ID="TextFieldGatewayPwdConfirm" FieldLabel="<%$ Resources:StringDef, PasswordConfirm %>" AnchorHorizontal="90%" InputType="Password" />
					<ext:NumberField runat="server" ID="NumFieldGateId" FieldLabel="<%$ Resources:StringDef, SvrCfgPaymentGateId %>" AnchorHorizontal="90%" />
					<ext:NumberField runat="server" ID="NumFieldGameId" FieldLabel="<%$ Resources:StringDef, SvrCfgPaymentGameId %>" Text="19" AnchorHorizontal="90%" />
					...
					<ext:TextField runat="server" ID="TextFieldJoinKey" FieldLabel="<%$ Resources:StringDef, SvrCfgPaymentJoinKey %>" AnchorHorizontal="90%" InputType="Password" Note="<%$ Resources:StringDef, MsgEmptyUseOriKey %>" />
			...
			<ext:FieldSet ID="FieldSet5" runat="server" Title="<%$ Resources:StringDef, SvrCfgLang %>" Collapsible="true" Layout="form">
				<Items>
					<ext:TextField runat="server" ID="TextFieldCharSet" FieldLabel="<%$ Resources:StringDef, SvrCfgLangCharSet %>" Text="gbk" AnchorHorizontal="90%" />
				</Items>
			</ext:FieldSet>
		</Items>
		<Buttons>

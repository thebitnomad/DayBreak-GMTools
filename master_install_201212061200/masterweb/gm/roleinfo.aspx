...
<asp:Content ID="Content3" ContentPlaceHolderID="TailHolder" Runat="Server">
	<ext:Store ID="StoreRole" runat="server" RemoteSort="true" RemotePaging="true" OnRefreshData="RoleInfoRefresh" AutoLoad="false">
		<DirectEventConfig Type="Load">
			<EventMask ShowMask="true" Msg="<%$ Resources:StringDef, Loading %>" Target="CustomTarget" CustomTarget="#{GridPanelRole}.body" MinDelay="100" />
		</DirectEventConfig>
		<Listeners>
	...
	<ext:Viewport ID="Viewport1" runat="Server">
		<Items>
			<ext:BorderLayout ID="BorderLayout1" runat="Server" StyleSpec="background-color:#FFF;" >
				<North>
					<ext:FormPanel ID="QueryPanel" runat="Server" LabelAlign="Right" LabelWidth="200" Title="<%$ Resources:StringDef, QueryCondition %>" Height="225" Padding="10" ButtonAlign="Center" Border="true" Margins="10px 10px 10px 10px">
						<Items>
							<ext:CompositeField ID="CompositeField2" runat="Server" FieldLabel="<%$ Resources:StringDef, GameServer %>" Width="550">
								<Items>
							...
							<ext:CompositeField runat="Server" FieldLabel="<%$ Resources:StringDef, Account %>" Width="550">
								<Items>
							...
							<ext:CompositeField ID="CompositeField1" runat="Server" FieldLabel="<%$ Resources:StringDef, RoleName %>" Width="550">
								<Items>
							...
							<ext:CompositeField ID="CompositeField3" runat="Server" FieldLabel="<%$ Resources:StringDef, RoleGUID %>" Width="550">
								<Items>
							...
							<ext:CompositeField ID="CompositeField4" runat="Server" FieldLabel="<%$ Resources:StringDef, IpAddress %>" Width="550">
								<Items>
				...
				<Center>
					<ext:GridPanel ID="GridPanelRole" runat="Server" Border="true" StoreID="StoreRole" Margins="10px 10px 10px 10px" Hidden="true" Title="<%$ Resources:StringDef, QueryResult %>">
						<%--<TopBar>
						...
						<ColumnModel>
							<Columns>
								...
								<ext:Column Header="<%$ Resources:StringDef, RoleType %>" DataIndex="RoleType" Width="120" Align="Center">
									<Renderer Fn="renderRoleType" />
								</ext:Column>
								<ext:Column Header="<%$ Resources:StringDef, RoleLevel %>" DataIndex="RoleLevel" Width="50" Align="Center">
								</ext:Column>
								<ext:Column Header="<%$ Resources:StringDef, OnlineState %>" DataIndex="Online" Width="100" Align="Center">
									<Renderer Fn="renderOnline" />
								</ext:Column>
								<ext:Column Header="<%$ Resources:StringDef, NoChatDate %>" DataIndex="NoChat" Width="150" Align="Center" Sortable="false">
								</ext:Column>
								<ext:Column Header="<%$ Resources:StringDef, NoLoginDate %>" DataIndex="NoLogin" Width="150" Align="Center" Sortable="false">
								</ext:Column>

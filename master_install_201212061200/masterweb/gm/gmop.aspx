				...
				<North>
					<ext:FormPanel ID="QueryPanel" runat="Server" LabelAlign="Right" LabelWidth="180" Title="<%$ Resources:StringDef, QueryCondition %>" Height="260" Padding="10" ButtonAlign="Center" Border="true" Margins="10px 10px 10px 10px">
						<Items>
							...
							<ext:CheckboxGroup ID="CheckboxGroupOpType" runat="Server" Width="650" ColumnsNumber="7" FieldLabel="<%$ Resources:StringDef, Operation %>" Vertical="true" >
								<Items>
									...
									<%--<ext:Checkbox runat="server" Value="11" BoxLabel="<%$ Resources:StringDef, ExecGlobalGMCommand %>" />--%>
									<ext:Checkbox ID="Checkbox1" runat="server" Tag="12" BoxLabel="<%$ Resources:StringDef, ResumeRole %>" Checked="true" />
								</Items>
							</ext:CheckboxGroup>
						</Items>
						<Buttons>

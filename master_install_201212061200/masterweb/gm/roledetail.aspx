					...
					<ext:TabPanel runat="Server" ID="TabPanelRoleInfo" TabPosition="Bottom" Border="false">
						<TopBar>
							<ext:Toolbar runat="Server">
								<Items>
									<ext:Button ID="BtnDisableChat" runat="server" Text="<%$ Resources:StringDef, DisableChat %>" Icon="Decline">
										<Listeners>
											<Click Handler="
												var accName = #{FieldHiddenAcc}.getValue( );
									...
									<ext:Button ID="BtnEnableChat" runat="server" Text="<%$ Resources:StringDef, EnableChat %>" Icon="Accept">
										<Listeners>
											<Click Handler="
												var accName = #{FieldHiddenAcc}.getValue( );
									...
									<ext:Button ID="BtnDisableLogin" runat="server" Text="<%$ Resources:StringDef, Freeze %>" Icon="Decline">
										<Listeners>
											<Click Handler="
												var accName = #{FieldHiddenAcc}.getValue( );
									...
									<ext:Button ID="BtnEnableLogin" runat="server" Text="<%$ Resources:StringDef, Unfreeze %>" Icon="Accept">
										<Listeners>
											<Click Handler="
												var accName = #{FieldHiddenAcc}.getValue( );
									...
									<ext:Button ID="BtnKickRole" runat="server" Text="<%$ Resources:StringDef, KickRole %>" Icon="Lightning">
										<Listeners>
											<Click Handler="
												var accName = #{FieldHiddenAcc}.getValue( );
									...
									<ext:Button ID="BtnResetPwd" runat="server" Text="<%$ Resources:StringDef, ResetStorePass %>" Icon="ControlRecord">
										<Listeners>
											<Click Handler="
												var accName = #{FieldHiddenAcc}.getValue( );
									...
									<ext:Button ID="BtnFreezeAcc" runat="server" Text="<%$ Resources:StringDef, FreezeAccount %>" Icon="UserDelete">
										<Listeners>
											<Click Handler="
												var accName = #{FieldHiddenAcc}.getValue( );
												var accId	= #{FieldHiddenAccId}.getValue( );
												gmOpSetAccountNoLogin( m_ggId, accName, m_roleName, accId, true, function( result ) {
												} );
											" />
										</Listeners>
									</ext:Button>
									<ext:Button ID="BtnUnfreezeAcc" runat="server" Text="<%$ Resources:StringDef, UnfreezeAccount %>" Icon="UserTick">
										<Listeners>
											<Click Handler="
												var accName = #{FieldHiddenAcc}.getValue( );
												var accId	= #{FieldHiddenAccId}.getValue( );
												gmOpSetAccountNoLogin( m_ggId, accName, m_roleName, accId, false, function( result ) {
												} );
											" />
										</Listeners>
									</ext:Button>
									...
									<ext:Button ID="BtnExport" runat="server" Text="<%$ Resources:StringDef, Export %>" Icon="ArrowOut">
										<Listeners>
											<Click Fn="btnExportClick" />
										</Listeners>
									</ext:Button>
									<ext:Button ID="BtnResume" runat="server" Text="<%$ Resources:StringDef, Resume %>" Icon="DriveKey">
										<Listeners>

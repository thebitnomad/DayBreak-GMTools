<%@ control language="C#" autoeventwireup="true" inherits="common_machinecombo, App_Web_machinecombo.ascx.38131f0b" %>

<ext:XScript ID="XScript1" runat="server">
	<script type="text/javascript">
		/* Todo: 第一次选择Region时，过滤不起作用的问题。 */
		var machineComboCabinetSelect = function( ) {
		...
		var machineComboGetSelectedSvrId = function( ) {
			return #{ComboMachine}.getValue( );
		};
		
		var machineComboGetSelectedRecord = function( ) {
		...
		var machineComboSetSelectedMachineId = function( machineId ) {
			#{ComboMachine}.setValue( machineId );
		};
		
		var machineComboInitData = function( machineId ) {

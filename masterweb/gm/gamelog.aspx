	...
	<ext:XScript ID="XScript1" runat="Server">
		<script type="text/javascript">
			...
			var storeRoleGetQueryParams = function( store, options ) {
				...
				var minI32		= #{TextFieldQueryMinI32}.getValue( );
				var maxI32		= #{TextFieldQueryMaxI32}.getValue( );
				var minU32		= #{TextFieldQueryMinU32}.getValue( );
				var maxU32		= #{TextFieldQueryMaxU32}.getValue( );
				var minI64		= #{TextFieldQueryMinI64}.getValue( );
				var maxI64		= #{TextFieldQueryMaxI64}.getValue( );
				...
				options.params.MinI32		= minI32;
				options.params.MaxI32		= maxI32;
				options.params.MinU32		= minU32;
				options.params.MaxU32		= maxU32;
				options.params.MinI64		= minI64;
				options.params.MaxI64		= maxI64;
...
//				btnConfig.setDisabled( record.data.ProcId == -1 );
			...
			var btnQueryItemsInfo = function( ) {
				#{WindowQueryItems}.show(  );
			};
			...
			var exportLog = function( ) {
				...
				var sort		= #{StoreLog}.getSortState( ).field;
				var orderAsc	= #{StoreLog}.getSortState( ).direction == "ASC";
				
				Ext.net.DirectMethods.ExportLog( 
					svrId,
					logStr1, logStr2, logStr3, logStr4,
					startTime, endTime,
					evtIds, roleName1, roleName2,
					minI32, maxI32, minU32, maxU32, minI64, maxI64,
					sort, orderAsc, {
//					eventMask: {
//						showMask: true,
//						minDelay: 200,
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" Runat="Server">
	...
	<ext:Viewport ID="Viewport1" runat="Server">
		<Items>
			<ext:BorderLayout ID="BorderLayout1" runat="Server" StyleSpec="background-color:#FFF;" >
				<North>
					<ext:FormPanel ID="QueryPanel" runat="Server" LabelAlign="Right" LabelWidth="200" Title="<%$ Resources:StringDef, QueryCondition %>" Height="350" PaddingSummary="10px 10px 0px 10px" ButtonAlign="Center" Border="true" Margins="10px 10px 0px 10px" AutoScroll="true">
						<Items>
							...
							<ext:CompositeField ID="CompositeField5" runat="Server" FieldLabel="<%$ Resources:StringDef, Time %>" Width="900" Note="<%$ Resources:StringDef, MsgGameLogQueryNote %>">
								<Items>
							...
							<ext:CompositeField ID="CompositeField3" runat="Server" FieldLabel="<%$ Resources:StringDef, LogKey4 %>" Width="600">
								<Items>
									...
									<ext:LinkButton ID="LinkButton4" runat="Server" Text="<%$ Resources:StringDef, ItemQuery %>">
										<Listeners>
											<Click Fn="btnQueryItemsInfo"/>
										</Listeners>
									</ext:LinkButton>
								</Items>
							</ext:CompositeField>
							<ext:CompositeField ID="CompositeField10" runat="Server" FieldLabel="<%$ Resources:StringDef, LogInt64 %>" Width="600">
								<Items>
									<ext:TextField runat="Server" ID="TextFieldQueryMinI64" Width="160">
										<Listeners>
											<SpecialKey Fn="textFieldQuerySpecialKey" />
										</Listeners>
									</ext:TextField>
									...
									<ext:TextField runat="Server" ID="TextFieldQueryMaxI64" Width="160">
										<Listeners>
											<SpecialKey Fn="textFieldQuerySpecialKey" />
										</Listeners>
									</ext:TextField>
							...
							<ext:CompositeField ID="CompositeField8" runat="Server" FieldLabel="<%$ Resources:StringDef, LogInt32 %>" Width="600">
								<Items>
									<ext:TextField runat="Server" ID="TextFieldQueryMinI32" Width="160">
										<Listeners>
											<SpecialKey Fn="textFieldQuerySpecialKey" />
										</Listeners>
									</ext:TextField>
									...
									<ext:TextField runat="Server" ID="TextFieldQueryMaxI32" Width="160">
										<Listeners>
											<SpecialKey Fn="textFieldQuerySpecialKey" />
										</Listeners>
									</ext:TextField>
							...
							<ext:CompositeField ID="CompositeField9" runat="Server" FieldLabel="<%$ Resources:StringDef, LogUInt32 %>" Width="600">
								<Items>
									<ext:TextField runat="Server" ID="TextFieldQueryMinU32" Width="160">
										<Listeners>
											<SpecialKey Fn="textFieldQuerySpecialKey" />
										</Listeners>
									</ext:TextField>
									...
									<ext:TextField runat="Server" ID="TextFieldQueryMaxU32" Width="160">
										<Listeners>
											<SpecialKey Fn="textFieldQuerySpecialKey" />
										</Listeners>
									</ext:TextField>
						...
						<BottomBar>
							<ext:PagingToolbar ID="PagingLog" runat="server" PageSize="200" StoreID="StoreLog">
								<Items>
									...
									<ext:Button runat="Server" ID="BtnExport" Icon="PageCode" ToolTip="<%$ Resources:StringDef, Export %>">
										<DirectEvents>
											<Click Method="POST" IsUpload="true" OnEvent="ExportLog" Before="
												var svrId		= svrComboGetSelectedSvrId( );
												...
												extraParams.LogStr1		= logStr1;
												extraParams.LogStr2		= logStr2;
												extraParams.LogStr3		= logStr3;
												extraParams.LogStr4		= logStr4;
												
												extraParams.MinI32		= minI32;
												extraParams.MaxI32		= maxI32;
												extraParams.MinU32		= minU32;
												extraParams.MaxU32		= maxU32;
												extraParams.MinI64		= minI64;
												extraParams.MaxI64		= maxI64;
												
												extraParams.RoleName1	= roleName1;
												extraParams.RoleName2	= roleName2;
									
												extraParams.EvtIds		= evtIds;
												extraParams.StartTime	= startTime;
												extraParams.EndTime		= endTime;
												
												extraParams.SvrId		= svrId;
												
												extraParams.Sort		= #{StoreLog}.getSortState( ).field;
												extraParams.OrderAsc	= #{StoreLog}.getSortState( ).direction == 'ASC';
											" >
											</Click>
										</DirectEvents>
									</ext:Button>	
	...
	<ext:Window ID="WindowQueryItems" runat="server" Resizable="true" Width="1000" Height="550" Padding="0" Title="<%$ Resources:StringDef, ItemQuery %>" CloseAction="Hide"
		Collapsible="false" Hidden="true" Modal="false">
		<AutoLoad Mode="IFrame" MaskMsg="<%$ Resources:StringDef, Loading %>" ShowMask="true" Url="itemquery.aspx">
		</AutoLoad>
	</ext:Window>

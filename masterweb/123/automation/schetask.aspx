	...
	<ext:XScript ID="XScript1" runat="Server">
		<script type="text/javascript">
			...
			var comboAutoSelect = function( combo, record, index ) {
				...
				#{FieldGMCommand}.setVisible( false );
				...
				switch( record.data.GUID ) {
					...
					case "{01BBAB49-2ACC-4afb-980A-8791F55060AB}":
						...
						break;
					case "{3A32EA06-5501-4ee0-B8A6-5A7E7FDDF840}":
						{
							#{FieldGMCommand}.setVisible( true ); 
						}
						break;
				}
			};
						...
						<Items>
							...
							<ext:FieldSet ID="FieldSet3" runat="server" Title="<%$ Resources:StringDef, TaskConfig %>" Collapsible="true" Layout="form">
								<Items>
									...
									<ext:TextArea runat="server" ID="FieldGMCommand" FieldLabel="<%$ Resources:StringDef, ShellCommand %>" Width="500" Height="50" >
									</ext:TextArea>
								</Items>
							</ext:FieldSet>
						</Items>

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" Runat="Server">
	...
	<ext:FormPanel ID="FormPanelAccountInfo" runat="Server" LabelAlign="Right" LabelWidth="120" Width="1000"
		Title="<%$ Resources:StringDef, AccountInfo %>" Padding="10" ButtonAlign="Center"
					...
					<ext:Button ID="BtnFreeze" runat="Server" Icon="UserDelete" Text="<%$ Resources:StringDef, Freeze %>">
						<Listeners>
							<Click Handler="
								...
								gmOpSetAccountNoLogin( -1, accName, '', accId, true, m_gameId, function( result ) {
									btnQueryClick( );
								} );
							" />
						</Listeners>
					...
					<ext:Button ID="BtnUnfreeze" runat="Server" Icon="UserTick" Text="<%$ Resources:StringDef, Unfreeze %>">
						<Listeners>
							<Click Handler="
								var accName = #{FieldAccount}.getValue( );
								var accId	= #{FieldAccID}.getValue( );
								gmOpSetAccountNoLogin( -1, accName, '', accId, false, m_gameId, function( result ) {
									btnQueryClick( );
								} );
							" />
						</Listeners>
		...
		<Items>
			...
			<ext:DisplayField ID="FieldTrusteeState" runat="Server" FieldLabel="<%$ Resources:StringDef, TrusteeState %>" Width="400">
			</ext:DisplayField>

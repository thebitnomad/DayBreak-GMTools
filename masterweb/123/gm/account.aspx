				...
				<Center>
					<ext:TabPanel ID="TabPanel1" runat="Server" Border="false" TabPosition="Bottom">
						<Items>
							...
							<ext:Panel ID="PanelBatchFreezeAccount" runat="Server" Title="<%$ Resources:StringDef, AccountBatchFreeze %>" >
								<AutoLoad Mode="IFrame" Url="accbatchfreeze.aspx" MaskMsg="<%$ Resources:StringDef, Loading %>" ShowMask="true" />
							</ext:Panel>
						</Items>
					</ext:TabPanel>
				</Center>

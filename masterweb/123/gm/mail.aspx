					...
					<ext:GridPanel ID="GridPanelMail" runat="Server" Border="true" StoreID="StoreMail" Margins="10px 10px 10px 10px" Hidden="true" Title="<%$ Resources:StringDef, QueryResult %>">
						<ColumnModel>
							<Columns>
								...
								<ext:Column Header="<%$ Resources:StringDef, Sender %>" DataIndex="Sender" Width="120">
								</ext:Column>
								<ext:Column Header="<%$ Resources:StringDef, Receiver %>" DataIndex="Receiver" Width="120">
								</ext:Column>
								<ext:Column Header="<%$ Resources:StringDef, Title %>" DataIndex="Title" Width="220" >
								</ext:Column>
								...
								<ext:Column Header="<%$ Resources:StringDef, PostMoney %>" DataIndex="PostMoney" Width="80" Align="Center">
								</ext:Column>
								<ext:Column Header="<%$ Resources:StringDef, CostMoney %>" DataIndex="MailCost" Width="80" Align="Center">
								</ext:Column>
